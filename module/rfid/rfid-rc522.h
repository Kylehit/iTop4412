 ...
 * @author   cc
 * @version  
 * @date     Tue 27 Feb 2018 04:37:49 AM PST
...
/**
 *@brief 寻卡
 *@param reg:寻卡方式 0x52 = 寻感应区内所有符合1443A标准的卡
 *					  0x26 = 寻未进入休眠的卡
 *		 type:卡片类型代码
 *@return 成功返回MI_OK
 */
char Rc522Request(unsigned char reg,unsigned char *type);
